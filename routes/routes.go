...
func RunApp() {
	...
	administratorGroup := app.Group("/administrator")
	{
		...
		administratorGroup.GET("", helpers.RedirectSlashRoute("/manage-user"))
		administratorGroup.GET("/manage-user", controllers.ManageUser)
		administratorGroup.GET("/add_New_User", controllers.AddNewUser)
		administratorGroup.POST("/save_user", controllers.SaveNewUser)
